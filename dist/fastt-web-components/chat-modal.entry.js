...
import { g as generateConversationId, m as marked, a as generateMessageId } from './marked.esm-D22uV4ub.js';
...
const ChatModal = class {
    ...
    render() {
        return (h(Host, { key: 'ed9f130c4ce7f2c3e70abddfb250404964712130' }, h("div", { key: 'f9367b7c543d63fe8a9746f7618aa9060f4a0f6d', class: "chat-container" }, h("div", { key: '1c93ecf6e821801f7183ce342b307254ed836cf7', class: "modal-header" }, h("span", { key: 'e7ef2328cff47110530261518cc628b4ed32ce49', class: "modal-title" }, this.modalTitle)), h("div", { key: '22acc5974f9d51ea5f7d305f1583650905f6f6ae', class: "chat-content" }, h("div", { key: 'af56f6f189f3ea4310d0ad57b8dd2d7a50aeb3fe', class: "message-container" }, this.messages.map((message, index) => (h("div", { key: index, class: {
                'message': true,
                'user-message': message.role === 'user',
                'ai-message': message.role === 'ai',
            } }, message.role === 'ai' ? (h(h.Fragment, null, this.isLoading && message.content === '' ? h("chat-skeleton", null) : h("div", { class: "markdown-content", innerHTML: this.renderMarkdown(message.content) }), message.isComplete && h("satisfaction-buttons", { "message-id": message.messageId, "api-endpoint": this.apiEndpoint }))) : (h("p", null, message.content)))))), h("form", { key: 'c6983bf07bdc8f6cce3ad883d90fd9897cf130f9', class: "input-container", onSubmit: this.handleSubmit }, h("input", { key: '68d95238188579fe0dd1f6c657fcd330f77c2b3d', name: "message", type: "text", placeholder: "Tapez votre message ici...", disabled: this.isLoading }), h("button", { key: 'fc44b778ef4425c6b5111d421bd915688f859ec1', type: "submit", disabled: this.isLoading, class: "send-button" }, this.isLoading ? ('Envoi...') : (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: this.iconSize, height: this.iconSize, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-send-horizontal-icon lucide-send-horizontal" }, h("path", { d: "M3.714 3.048a.498.498 0 0 0-.683.627l2.843 7.627a2 2 0 0 1 0 1.396l-2.842 7.627a.498.498 0 0 0 .682.627l18-8.5a.5.5 0 0 0 0-.904z" }), h("path", { d: "M6 12h16" })))))))));
    }
};
