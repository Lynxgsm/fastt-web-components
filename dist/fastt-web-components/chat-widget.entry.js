...
const ChatWidget = class {
    ...
    render() {
        return [
            ...
            ] : h("span", null, message.content))))), h("div", { key: 'd26b7a047d3b5faa20b33a569d6b996a97b129a7', class: "typing-indicator" }, this.isLoading ? 'AI is typing...' : ''), h("form", { key: '101e0c78ad8129c8b55c2d14b4c9a8c70f9e8f24', class: "input-container", onSubmit: this.handleSubmit }, h("input", { key: '78c7dfed2e3b13c0d2655e91e990564b025651c9', type: "text", placeholder: "Type a message...", name: "message", required: true, class: "input", ref: this.setInputRef }), h("button", { key: '0eabe8b7ea0c808b54c72223ac4546d2cfc59080', type: "submit", disabled: this.isLoading, class: "send-button" }, this.isLoading ? 'Envoi...' : (h("svg", { class: "send-icon", xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("line", { x1: "22", y1: "2", x2: "11", y2: "13" }), h("polygon", { points: "22 2 15 22 11 13 2 9 22 2" })))))),
            h("button", { key: 'bb02e22fe7878e3a45c9ae7629192b9ebf2c6e61', class: "chat-toggler", onClick: this.toggleChatContainer }, h("svg", { key: '2c171c15200206d01d290901ffb7167a64acac07', xmlns: 'http://www.w3.org/2000/svg', width: '24', height: '24', viewBox: '0 0 24 24', fill: 'none', stroke: 'white', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round' }, h("path", { key: '98007ba52447f7c7909c28c9b6c362d124510cbf', d: 'M7.9 20A9 9 0 1 0 4 16.1L2 22Z' })))
        ];
    }
};
