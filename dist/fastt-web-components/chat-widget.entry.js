import { r as registerInstance, E as Env, h } from './index-BKKbgT-O.js';
import { c as callAIStream } from './api-service-BUqu-bxk.js';
import { g as generateConversationId, m as marked } from './marked.esm-D22uV4ub.js';
...
const ChatWidget = class {
    ...
    render() {
        return [
            h("div", { key: '5127ef9d5ad18bc00ef2bb43ea741997eac9662c', class: {
                    'chat-widget-container': true,
                    'hide': !this.isChatContainerVisible,
                } }, h("div", { key: 'd97cde5f7cd9d99fac8aa67704a5cbe715a003d6', class: "chat-header" }, h("h3", { key: '389fe36486fe7849b1ce5660aa6ea22d6b179ed5', class: "chat-title" }, "Que puis-je faire pour vous ?"), h("button", { key: 'c6384d7e8ba9c8d4346d196c68c7d1defdbaeab2', class: "close-button", onClick: this.toggleChatContainer }, "\u00D7")), h("div", { key: 'ee6d1a4cc5fadcd92a8d28df858f3b0f04c6eea5', class: "message-container" }, this.messages.map((message, index) => (h("div", { key: index, class: {
                    'message': true,
                    'user-message': message.role === 'user',
                    'ai-message': message.role === 'ai',
                } }, message.role === 'ai' ? (h(h.Fragment, null, this.isLoading && message.content === '' ? (h("chat-skeleton", null)) : (h(h.Fragment, null, h("div", { class: "markdown-content", innerHTML: this.renderMarkdown(message.content) }), message.isComplete && h("satisfaction-buttons", { "api-endpoint": this.apiEndpoint, "message-id": message.messageId }))))) : (h("span", null, message.content)))))), h("form", { key: '14c5a907960d8b652a5f6ddeb47205bfcb2b79f0', class: "input-container", onSubmit: this.handleSubmit }, h("input", { key: '5a2abea25c0155219ca847da4c25ae0d8c907e2b', type: "text", placeholder: "Tapez un message...", name: "message", required: true, class: "input", ref: this.setInputRef }), h("button", { key: '7976ec084a42fb87ba03795606862bf1ca7ab35a', type: "submit", disabled: this.isLoading, class: "send-button" }, this.isLoading ? ('Envoi...') : (h("svg", { class: "send-icon", xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("line", { x1: "22", y1: "2", x2: "11", y2: "13" }), h("polygon", { points: "22 2 15 22 11 13 2 9 22 2" })))))),
            h("button", { key: '56d63f1493e0a0d070bd40b35572cbff15dc6f3a', class: "chat-toggler", onClick: this.toggleChatContainer }, h("svg", { key: '427786eb5eda1a0637c935c193c0010e8078d431', xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, h("path", { key: 'b8b63b4117cb6d8000529fd998054493905ec223', d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z" }))),
        ];
    }
};
