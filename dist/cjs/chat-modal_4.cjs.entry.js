...
const ChatModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d1c6fb5c472a1dfa1917a14e9d50ac63301e63b' }, index.h("div", { key: 'a33f74e30f8ad6cc66593f3e64ee34743a295d32', class: { 'modal-overlay': true, visible: this.open } }, index.h("div", { key: 'c0fd9b92dae0ff6f3bb4e84585fcdf9d8d080e6f', class: "chat-container" }, index.h("div", { key: '25b06d7a50df99b0d5691571661ede1a3e3e52e6', class: "modal-header" }, index.h("span", { key: '8c0cd44cfd26f8350a12023cdc8a631cec20eec5', class: "modal-title" }, this.modalTitle), index.h("button", { key: '4fe88e5aefc7f776ec4def8315be553fdea9decf', class: "close-button", onClick: this.closeModal, "aria-label": "Close" }, "\u00D7")), index.h("div", { key: '19342d09f8dc4434fd964fde3976265a0d41d30d', class: "chat-content" }, index.h("div", { key: 'bc1eb5a51e8cb5b80fe583a7f61e378945ba28c3', class: "message-container" }, this.messages.map((message, index$1) => (index.h("div", { key: index$1, class: {
                'message': true,
                'user-message': message.role === 'user',
                'ai-message': message.role === 'ai',
            } }, message.role === 'ai' ? (index.h(index.h.Fragment, null, this.isLoading && message.content === '' ? (index.h("chat-skeleton", null)) : message.content, message.isComplete && index.h("satisfaction-buttons", null))) : (index.h("p", null, message.content)))))), index.h("form", { key: '079d3496eec9c76111686833e851fc1b29a210cf', class: "input-container", onSubmit: this.handleSubmit }, index.h("input", { key: 'a39f280258526d906df55fc27413ea3ad1c1c1e4', name: 'message', type: 'text', placeholder: 'Tapez votre message ici...', disabled: this.isLoading }), index.h("button", { key: 'e18084fd8b072d09be98bbe826540c36d18caf20', type: 'submit', disabled: this.isLoading, class: "send-button" }, this.isLoading ? 'Envoi...' : index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: this.iconSize, height: this.iconSize, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-send-horizontal-icon lucide-send-horizontal" }, index.h("path", { d: "M3.714 3.048a.498.498 0 0 0-.683.627l2.843 7.627a2 2 0 0 1 0 1.396l-2.842 7.627a.498.498 0 0 0 .682.627l18-8.5a.5.5 0 0 0 0-.904z" }), index.h("path", { d: "M6 12h16" })))))))));
    }
};
...
const ChatWidget = class {
    ...
    render() {
        return [
            index.h("div", { key: '156eb7a80031b49df706a632dc00b9530d9f2335', class: {
                    'chat-widget-container': true,
                    'hide': !this.isChatContainerVisible,
                } }, index.h("div", { key: '403c95ad63457e4caf334f86e0b879a8b9bb15aa', class: "chat-header" }, index.h("h3", { key: '425a615b8207400ef76db7904c1f9d87ec4bce04', class: "chat-title" }, "Que puis-je faire pour vous ?"), index.h("button", { key: 'cc4995092f55377b8b9538c014bbf645736e1ab5', class: "close-button", onClick: this.toggleChatContainer }, "\u00D7")), index.h("div", { key: 'dd8f859ae760ad17655947da4dc181f06f67eaf7', class: "message-container" }, this.messages.map((message, index$1) => (index.h("div", { key: index$1, class: {
                    'message': true,
                    'user-message': message.role === 'user',
                    'ai-message': message.role === 'ai',
                } }, message.role === 'ai' ? [
            ...
            ] : index.h("span", null, message.content))))), index.h("div", { key: 'f67637753fd5e819a1debff48b4e226bd93817ba', class: "typing-indicator" }, this.isLoading ? 'AI is typing...' : ''), index.h("form", { key: '6855a2bdd90a54a5db8995f99d236749873fd3a7', class: "input-container", onSubmit: this.handleSubmit }, index.h("input", { key: '8320603dfdc81c18e4c7435d9c7fba857a67d7c0', type: "text", placeholder: "Type a message...", name: "message", required: true, class: "input", ref: this.setInputRef }), index.h("button", { key: '780213dfa22364c7ecb7c3318c24f0bdd0199b96', type: "submit", disabled: this.isLoading, class: "send-button" }, this.isLoading ? 'Envoi...' : (index.h("svg", { class: "send-icon", xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("line", { x1: "22", y1: "2", x2: "11", y2: "13" }), index.h("polygon", { points: "22 2 15 22 11 13 2 9 22 2" })))))),
            index.h("button", { key: '37ec9635e319e4bfe5ea1a6a90c10847f6186201', class: "chat-toggler", onClick: this.toggleChatContainer }, index.h("svg", { key: '662342c9deb1b82a35133a3f9a91843d4f17e327', xmlns: 'http://www.w3.org/2000/svg', width: '24', height: '24', viewBox: '0 0 24 24', fill: 'none', stroke: 'white', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round' }, index.h("path", { key: '83e763b01ce059dd6faefc4878f97cfca92e4a32', d: 'M7.9 20A9 9 0 1 0 4 16.1L2 22Z' })))
        ];
    }
};
